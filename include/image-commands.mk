...
define Build/uImage
	mkimage -A $(LINUX_KARCH) \
		...
		-n '$(if $(UIMAGE_NAME),$(UIMAGE_NAME),$(call toupper,$(LINUX_KARCH)) KOS Linux-$(LINUX_VERSION))' -d $@ $@.new
	@mv $@.new $@
endef
...
define Build/netgear-dni
	$(STAGING_DIR_HOST)/bin/mkdniimg \
		-B $(NETGEAR_BOARD_ID) -v KOS.$(REVISION) \
...
define Build/append-uImage-fakeroot-hdr
	...
	$(STAGING_DIR_HOST)/bin/mkimage \
		...
		-n '$(call toupper,$(LINUX_KARCH)) KOS fakeroot' \
		-s \
		$@.fakeroot
	cat $@.fakeroot >> $@
endef
