...
define LegacyDevice/BXO2000N2S
  DEVICE_TITLE :=BHU BXO2000n-2S
  DEVICE_PACKAGES :=kmod-usb-core kmod-usb-ohci kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += BXO2000N2S

define LegacyDevice/BXO2000N2SU
  DEVICE_TITLE :=BHU BXO2000n-2S-U
  DEVICE_PACKAGES :=kmod-usb-core kmod-usb-ohci kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += BXO2000N2SU

define LegacyDevice/BXI2000N2
  DEVICE_TITLE :=BHU BXI2000n-2
  DEVICE_PACKAGES :=kmod-usb-core kmod-usb-ohci kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += BXI2000N2

define LegacyDevice/BXI2000N2V2
  DEVICE_TITLE :=BHU BXI2000n-2-V2
  DEVICE_PACKAGES :=kmod-usb-core kmod-usb-ohci kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += BXI2000N2V2

define LegacyDevice/BXO5000N2S
  DEVICE_TITLE :=BHU BXO5000n-2S
  DEVICE_PACKAGES :=kmod-usb-core kmod-usb-ohci kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += BXO5000N2S

define LegacyDevice/BXO5000N2SV2
  DEVICE_TITLE :=BHU BXO5000n-2S-V2
  DEVICE_PACKAGES :=kmod-usb-core kmod-usb-ohci kmod-usb2 kmod-usb-storage
endef
LEGACY_DEVICES += BXO5000N2SV2
...
define LegacyDevice/KOSQCA953XB
  DEVICE_TITLE := UOSBOX KOS-QCA953X-B
endef
LEGACY_DEVICES += KOSQCA953XB
